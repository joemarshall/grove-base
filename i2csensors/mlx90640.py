...
class MLX90640:  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, address: int = 0x33) -> None:
    ...
    def get_frame(self, framebuf: List[int]) -> None:
    ...
    def _I2CWriteWord(self, writeAddress: int, data: int) -> None:
        ...
        self.i2c_device.i2c_rdwr(smbus.i2c_msg.write(self.i2c_address, cmd))
    ...
    def _I2CReadWords(
        ...
        while remainingWords:
            ...
            i2c_commands = [
                smbus.i2c_msg.write(self.i2c_address, addrbuf),
                smbus.i2c_msg.read(self.i2c_address, read_words * 2),
            ]
            #                print(read_words)
            self.i2c_device.i2c_rdwr(*i2c_commands)
            #                print(i2c_commands[-1].len)
            inbuf = i2c_commands[-1].buf
